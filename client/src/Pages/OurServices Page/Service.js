...
import {getLocalStorages} from "../../utils/cookie"
...
export class Service extends Component {
    ...
    componentDidMount = () => {
      ...
      axios
        .post(`${API}/user/log/get-log`, { Email })
        .then((res) => {
          console.log(res);
          const {
            Name,
    ...
    handleSubmit = (event) => {
      ...
      console.log(result);
      axios.post(`${API}/user/log/breakfast`,result).then(res=>{
    ...
    handleSubmit1 = (event) => {
      ...
      console.log(result);
      axios.post(`${API}/user/log/lunch`,result).then(res=>{
          console.log('sucessfully submitted', res);
          this.setState({
              qty1:"",
              name1:"Rice (Brown)"
    ...
    handleSubmit2 = (event) => {
      ...
      console.log(result);
      axios.post(`${API}/user/log/dinner`,result).then(res=>{
          console.log('sucessfully submitted', res);
          this.setState({
              qty2:"",
              name2:"Rice (Brown)"
  ...
  breakfastCall=(event)=>{
    ...
    axios.post(`${API}/user/cal/get-breakfast`,{
     Email:email,
     date:date
    }).then(res=>{
      this.setState({
  ...
  lunchCall=(event)=>{
    ...
    const email=  getLocalStorages();
    const date = new Date().getDate() + "-" + (new Date().getMonth()+1)  + "-" + (new Date().getFullYear());
    axios.post(`${API}/user/cal/get-lunch`,{
     Email:email,
     date:date
    }).then(res=>{
      this.setState({
  ...
  dinnerCall=(event)=>{
    ...
    const email=  getLocalStorages();
    const date = new Date().getDate() + "-" + (new Date().getMonth()+1)  + "-" + (new Date().getFullYear());
    axios.post(`${API}/user/cal/get-dinner`,{
     Email:email,
     date:date
    }).then(res=>{
      this.setState({
  ...
  totalCall=(event)=>{
    ...
    const email=  getLocalStorages();
    const date = new Date().getDate() + "-" + (new Date().getMonth()+1)  + "-" + (new Date().getFullYear());
    axios.post(`${API}/user/cal/get-total`,{
     Email:email,
     date:date
    }).then(res=>{
      this.setState({
