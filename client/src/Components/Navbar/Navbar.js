...
import  {isAuth,getLocalStorage} from "../../utils/cookie"
...
const navbar = () => {
    ...
    <NavLink className="navbar-brand" to="/">  EatFit</NavLink >
    ...
    <NavLink  activeClassName="menu_active" className="nav-link" to="/profile">{getLocalStorage()}</NavLink >
